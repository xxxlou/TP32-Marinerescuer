...
?>],
            backgroundColor: [
                ...
                foreach($values[$i] as $vci=>$valuecolor){
                    echo guaven_sqlcharts_colorgenerator(1, 0, 0, guaven_sqlcharts_colors($vci, $pid));
                }       
?>
            ],
            hoverBackgroundColor: [
               <?php
               foreach($values[$i] as $vci=>$valuecolor){
                echo guaven_sqlcharts_colorgenerator(1, 0, 0.2, guaven_sqlcharts_colors($vci, $pid));
            } 
?>
            ]
        },
