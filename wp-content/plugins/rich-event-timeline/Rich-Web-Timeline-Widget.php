			...
			<style type="text/css">
				<?php if($get_timeline_style_options[0]->rw_timeline_theme == 1) { ?>
					...
					@media (max-width: 767px) {
						...
						section.rich_web_timeline_<?php echo $rw_ti_id;?> > article > div.rich_web_timeline_panel div.rich_web_timeline_panel-body { z-index: 10; padding: 5px; margin: 0 !important;}
						section.rich_web_timeline_<?php echo $rw_ti_id;?> > article > div.rich_web_timeline_panel div.rich_web_timeline_panel-body,
				...
				@media (max-width: 767px) {
					.rich_web_div_block_<?php echo $rw_ti_id;?> section.rich_web_timeline_<?php echo $rw_ti_id;?>:before{
...
/*Pagination1*/
				...
				#pagination<?php echo $rw_ti_id;?> ul {
				  list-style: none;
				  padding: 0;
				  margin: 0;
				  display: flex;
				...
				#pagination<?php echo $rw_ti_id;?> ul li{

				}
				
				#pagination<?php echo $rw_ti_id;?> ul li a {
				  background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_02 ;?>;
				  color: <?php echo $get_timeline_style_options[0]->rw_timeline_04 ;?>;
				  font-family: <?php echo $get_timeline_style_options_2[0]->rw_timeline_08 ;?>;
				  font-size: <?php echo $get_timeline_style_options_2[0]->rw_timeline_07 ;?>px;
				  padding: 5px 10px;
				  margin: 2px;
				  border-right: 0;
				}
				#pagination<?php echo $rw_ti_id;?> ul li.active a {
				  background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
				  color:  <?php echo $get_timeline_style_options_2[0]->rw_timeline_03 ;?>;
				}
		
				#pagination<?php echo $rw_ti_id;?> ul li a:hover{
					background:<?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>;
					color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;
				}
...
/*Pagination2*/
				...
				#pagination<?php echo $rw_ti_id;?> ul a.active {
				  cursor: default;
				}
				#pagination<?php echo $rw_ti_id;?> ul a:active {
				  outline: none;
				}
				#pagination<?php echo $rw_ti_id;?> ul li:first-child a {
				  margin-left: 3px;
				  line-height: 30px;
				...
				#pagination<?php echo $rw_ti_id;?> ul li:last-child a {
				  margin-left: 3px;
				  line-height: 30px;
				  -moz-border-radius: 100%;
				  -webkit-border-radius: 100%;
				...
				#pagination<?php echo $rw_ti_id;?> ul li a:hover {
				  background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>;
				  color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;
				}
				#pagination<?php echo $rw_ti_id;?> ul li.active a {
				  background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
...
/*Pagination3*/
			...
			#pagination<?php echo $rw_ti_id;?> ul li:hover,
			{
			...
			#pagination<?php echo $rw_ti_id;?> ul li:hover a{
				color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;				
			}
			#pagination<?php echo $rw_ti_id;?> ul li:hover {
				background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>;
			...
			#pagination<?php echo $rw_ti_id;?> ul li.active {
				background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;				
			}
			...
			#pagination<?php echo $rw_ti_id;?> ul li:last-child {
				margin: 0 0 0 0.5em;
				border-right: none;
			}
			...
			#pagination<?php echo $rw_ti_id;?> ul li a:first-child:before,
			#pagination<?php echo $rw_ti_id;?> ul li a:last-child:after {
			  font-family: 'entypo';
			  speak: none;
			  font-style: normal;
			  font-weight: normal;
...
/*pagination4*/
				...
				#pagination<?php echo $rw_ti_id;?> { text-align: center; }
				#pagination<?php echo $rw_ti_id;?> ul {
				    display: inline-flex;
				    border-radius: 0;
				    overflow: hidden;
...
/*pagination 5*/
			...
			#pagination<?php echo $rw_ti_id;?> ul li a {
			    ...
			    border: 2px solid <?php echo $get_timeline_style_options_2[0]->rw_timeline_02 ;?>;
			    border-radius: 50%;
			    overflow: hidden;
			    position: relative;
			    z-index: 1;
			...
			#pagination<?php echo $rw_ti_id;?> ul li:last-child a{ margin-right: 0;  }
			#pagination<?php echo $rw_ti_id;?> ul li.active a
			{color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_03 ;?>;
			    background-color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
			    border: 2px solid <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
			}

			#pagination<?php echo $rw_ti_id;?> ul li a:hover{
				color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;				
				background-color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>;
			    border: 2px solid <?php echo $get_timeline_style_options[0]->rw_timeline_06 ;?>;
			}
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:after,
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:before{
				background-color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
				width: 100%;
				height: 100%;
			}
			#pagination<?php echo $rw_ti_id;?> ul li a:before,
			#pagination<?php echo $rw_ti_id;?> ul li a:after{
			    content: '';
			    background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
			   	padding: 20px 24px;
			    border-radius:50%;
			...
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:before,
			#pagination<?php echo $rw_ti_id;?> ul li.active a:before,
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:after,
			#pagination<?php echo $rw_ti_id;?> ul li.active a:after{
			    top: 8px;
			}
...
/*Pagination 6*/
			...
			#pagination<?php echo $rw_ti_id;?> ul li.active a:hover
			{
			    color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;
			...
			#pagination<?php echo $rw_ti_id;?> ul li:hover a:after{
				background-color:  <?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>; 
			}
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:before{
				background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;
			}		
			#pagination<?php echo $rw_ti_id;?> ul li.previous a,
			#pagination<?php echo $rw_ti_id;?> ul li.next a{
			    height: 50px;
			    line-height: 40px;
			    background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_04 ;?>;
			    font-size: 17px;
			    color: <?php echo $get_timeline_style_options[0]->rw_timeline_04 ;?>;
			    -webkit-clip-path: polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%);
			    clip-path: polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%);
			}
			#pagination<?php echo $rw_ti_id;?> ul li.next a{ margin-right: 0; }
			#pagination<?php echo $rw_ti_id;?> ul li.previous a:hover,
			#pagination<?php echo $rw_ti_id;?> ul li.next a:hover{
			    background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>;
			    color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05 ;?>;
			...
			#pagination<?php echo $rw_ti_id;?> ul li a:before{
			    ...
			    width: 0;
			    height: 2px;
			    background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_03 ;?>;
			    position: absolute;
			    bottom: 0;
			    left: 0;
			...
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:before,
			#pagination<?php echo $rw_ti_id;?> ul li.active a:before{ width: 100%; }
			#pagination<?php echo $rw_ti_id;?> ul li a:after{
			    content: "";
			    width: 17px;
			    height: 17px;
			...
			ul li:first-child a:hover:after{ display: none; }
			@media only screen and (max-width: 480px){
			    ul { display: block; }
			    ul li{
			        display: inline-block;
...
/*Pagination 7*/
			...
			#pagination<?php echo $rw_ti_id;?> ul li:hover a:before,
			#pagination<?php echo $rw_ti_id;?> ul li:hover a:after{
				background-color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_06 ;?>; 
			   	}
			#pagination<?php echo $rw_ti_id;?> ul li.next a, #pagination<?php echo $rw_ti_id;?> ul li.previous a{
				width: unset;
				height: unset;
				padding: 20px;
				border-radius: 15px;
			...
			#pagination<?php echo $rw_ti_id;?> ul li.previous:hover a {
				border-radius: 15px;
				background-color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_06;?>;
				color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_05;?>;
				box-shadow: 0 4px 8px 4px rgba(0,0,0,0.4);
			}
			#pagination<?php echo $rw_ti_id;?> ul li.next:hover a {
				border-radius: 15px;
				color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_05;?>;
				background-color:<?php echo $get_timeline_style_options_2[0]->rw_timeline_06;?>;
				box-shadow: 0 4px 8px 4px rgba(0,0,0,0.4);
			}
			#pagination<?php echo $rw_ti_id;?> ul li a { margin-right: 20px; }
			#pagination<?php echo $rw_ti_id;?> ul li a { margin-left: 20px; }
		
			#pagination<?php echo $rw_ti_id;?> ul li a:hover{ color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05;?>; }

			#pagination<?php echo $rw_ti_id;?> ul li.next a:before{
				display: none;
			}
			#pagination<?php echo $rw_ti_id;?> ul li.previous a:before{
				display: none;
			}
			#pagination<?php echo $rw_ti_id;?> ul li a:hover:before,
			#pagination<?php echo $rw_ti_id;?> ul li.active a:before {
		...
		<?php } ?>
			...
			#loadMore<?php echo $rw_ti_id;?>{
				box-sizing: border-box;
				padding: 7px;
				text-align: center;
				background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_02;?>;
				color: <?php echo $get_timeline_style_options[0]->rw_timeline_04;?>;
				cursor: pointer;
				border-radius: 100px;
				border:2px solid <?php echo $get_timeline_style_options_2[0]->rw_timeline_03;?>;
				font-size: <?php echo $get_timeline_style_options_2[0]->rw_timeline_07;?>px;
				font-family: <?php echo $get_timeline_style_options_2[0]->rw_timeline_08;?>;
				}
				
				
			#loadMore<?php echo $rw_ti_id;?>:hover{
				background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_06;?>;
				border:2px solid <?php echo $get_timeline_style_options_2[0]->rw_timeline_03;?>;
				color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_05;?>;
					}
						...
						?>
							<article data-year="<?php echo  $list[$k]; ?>" class="" data-tim="rw_tim" id="rich_web_timeline_article" style="overflow: visible; <?php echo $ti_style_width;?> margin: 0 <?php echo $style_ti_mb;?>; padding: 0; opacity:1; <?php echo $ti_style_article;?>">
								<div class="rich_web_timeline_panel" style="margin: 0 <?php echo $style_ti_p_mb;?>; <?php echo $ti_panel_width;?> <?php echo $ti_panel_style;?>">
									<div class="rich_web_timeline_badge" style="<?php echo $style_ti_3;?> font-size: 13.2px; border-color: <?php echo $get_timeline_style_options[0]->rw_timeline_border_col;?>"><?php echo $get_timeline_options[$i]->rw_timeline_day.' '.$rw_timeline_month;?></div>
			...
			<?php if($get_timeline_style_options[0]->rw_timeline_theme != 3) { ?>
				<?php if($get_timeline[0]->rw_timeline_01 == "Pagination"){ ?>
					<div id="pagination<?php echo $rw_ti_id;?>"></div>
				<?php } ?>
				<?php if($get_timeline[0]->rw_timeline_01 == "Load More"){ ?>
					<div id="loadMore<?php echo $rw_ti_id;?>"><?php echo $get_timeline[0]->rw_timeline_03 ; ?></div>
				<?php } ?>
			<?php } ?>
			<?php if($get_timeline_style_options[0]->rw_timeline_theme != 3) { ?>
			<script type="text/javascript">
				let pages = <?php echo ceil(count($get_timeline_options)/$get_timeline[0]->rw_timeline_02); ?>;
				let count = <?php echo $get_timeline[0]->rw_timeline_02; ?>;
				let showType = "<?php echo $get_timeline[0]->rw_timeline_01; ?>";

				

				// loadMore
				if(showType == "Load More"){
					document.getElementById('loadMore<?php echo $rw_ti_id;?>').onclick = createLoadMore;
				}
				var counter = 1;
				function createLoadMore(){
					if(counter == pages){
					  	jQuery("#loadMore<?php echo $rw_ti_id;?>").hide();
					}
					if(showType != "Load More"){
						return;
					}
					...
					var array = [];
					  ...
					  allYearsArr.forEach(function(item,index){
					  	...
					  	var y = array.some(function(value){ return value==item.innerText; })
					  	if(y==false){
				...
				if(showType == "Pagination"){
					document.getElementById('pagination<?php echo $rw_ti_id;?>').innerHTML = createPagination(pages, 0);
				}
				function createPagination(pages, page) {
				  ...
				  if (page != 0) {
				  	jQuery("html, body").animate({ scrollTop: jQuery('.rich_web_ti_content_<?php echo $rw_ti_id;?>').position().top+80 }, 1000);				  
				  }
				  else{
				  	page=1;
				  }
				  ...
				  if (page > 1) {
				    str += '<li class="page-item previous no"><a onclick="createPagination(pages, '+(page-1)+')"><?php echo $get_timeline[0]->rw_timeline_04 ; ?></a></li>';
				  }
				  ...
				  if (page < pages) {
				    str += '<li class="page-item next no"><a onclick="createPagination(pages, '+(page+1)+')"><?php echo $get_timeline[0]->rw_timeline_05 ; ?></a></li>';
				  }
				  str += '</ul>';
				  // Return the pagination string to be outputted in the pug templates
				  document.getElementById('pagination<?php echo $rw_ti_id;?>').innerHTML = str;
				  return str;
				}
			</script>
			<?php } ?>
		...
		<?php }
			if($get_timeline_style_options[0]->rw_timeline_theme == 5 OR $get_timeline_style_options[0]->rw_timeline_theme == 6) 
			{
				...
				<style>
					...
					#rw_timeline_<?php echo $rw_ti_id;?> #rw_year_<?php echo $rw_ti_id;?> {height: 55px; margin: 15px 0 0 -35px !important; border-bottom: 1px solid <?php echo $get_timeline_style_options[0]->rw_timeline_line_col;?>;}
		...
		<?php }
			...
			?>
				<style>
					...
					.RW_TImeline_Ev_<?php echo $rw_ti_id;?> .dates-bar_<?php echo $rw_ti_id;?> a.rw_tim_prev_<?php echo $rw_ti_id;?>,.RW_TImeline_Ev_<?php echo $rw_ti_id;?> .dates-bar_<?php echo $rw_ti_id;?> a.rw_tim_next_<?php echo $rw_ti_id;?>{background: <?php echo $get_timeline_style_options_2[0]->rw_timeline_md_bg_color;?>; position:absolute;top:0;width:50px;min-width:0;color: <?php echo $get_timeline_style_options_2[0]->rw_timeline_icon_col;?> !important; font-size: <?php echo $get_timeline_style_options_2[0]->rw_timeline_icon_size;?>px !important;line-height:70px;transition: all .5s !important; -moz-transition: all .5s !important; -webkit-transition: all .5s !important;z-index:2;display:inline-block;}
