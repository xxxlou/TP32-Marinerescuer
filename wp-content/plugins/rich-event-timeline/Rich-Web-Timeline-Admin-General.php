	...
	<div class="Rich_Web_Timeline_Content">
		<div class="Rich_Web_Timeline_Table_Data_Option">
			...
			<table class="RW_TI_Table_G_2">
				<?php for($i=0;$i<count($get_timeline_style);$i++){ ?>
					<tr class='RW_TI_Table_G_2_Tr'>
						...
						<?php if($get_timeline_style[$i]->rw_timeline_theme == "Amazing" || $get_timeline_style[$i]->rw_timeline_theme == "Classic") { ?>
							<td><?php echo  $get_timeline_style[$i]->rw_timeline_theme . ' Timeline';?></td>
						<?php } else { ?>
				...
				<tr class='RW_TI_Table_G_2_Tr'>
					...
					<td><a href="https://rich-web.org/wordpress-timeline-amazing/" target="_blank">Demo 1</a></td>
					<td><a href="https://rich-web.org/wordpress-timeline-amazing-2/" target="_blank">Demo 2</a></td>
					<td></td>
				</tr>
				<tr class='RW_TI_Table_G_2_Tr'>
					<td><?php echo $i+2;?></td>
					...
					<td><a href="https://rich-web.org/wordpress-timeline-classic/" target="_blank">Demo 1</a></td>
					<td><a href="https://rich-web.org/wordpress-timeline-classic-2/" target="_blank">Demo 2</a></td>
					<td></td>
				</tr>
					<tr class='RW_TI_Table_G_2_Tr'>
					<td><?php echo $i+3;?></td>
					...
					<td><a href="https://rich-web.org/wordpress-timeline-fashion/" target="_blank">Demo 1</a></td>
					<td><a href="https://rich-web.org/wordpress-timeline-fashion-2/" target="_blank">Demo 2</a></td>
					<td></td>
				</tr>
				<tr class='RW_TI_Table_G_2_Tr'>
					<td><?php echo $i+4;?></td>
					...
					<td><a href="https://rich-web.org/wordpress-timeline-twist/" target="_blank">Demo 1</a></td>
					<td><a href="https://rich-web.org/wordpress-timeline-twist-2/" target="_blank">Demo 2</a></td>
					<td></td>
				</tr>
				<tr class='RW_TI_Table_G_2_Tr'>
					<td><?php echo $i+5;?></td>
					...
					<td><a href="https://rich-web.org/wordpress-timeline-double-sided/" target="_blank">Demo 1</a></td>
					<td><a href="https://rich-web.org/wordpress-timeline-double-sided-2/" target="_blank">Demo 2</a></td>
					<td></td>
				</tr>
			</table>
		</div>
		<div class="Rich_Web_New_Timeline_Option">
			...
			<table class="RW_Ti_Option_Table" id="RW_Ti_Option_TiTable">
				...
				<tr>
					...
					<td>
						<select class="Rich_Web_TI_Select_Menu rw_timeline_data_format" name="RW_TimeLine_7_DFormat" id="RW_TimeLine_7_DFormat">
							<option value="yy-mm-dd"  <?php if($get_timeline_style[0]->rw_timeline_01=='yy-mm-dd'){ echo 'selected';}?>>  yy-mm-dd  </option>
							<option value="yy MM dd"  <?php if($get_timeline_style[0]->rw_timeline_01=='yy MM dd'){ echo 'selected';}?>>  yy MM dd  </option>
							<option value="dd-mm-yy"  <?php if($get_timeline_style[0]->rw_timeline_01=='dd-mm-yy'){ echo 'selected';}?>>  dd-mm-yy  </option>
							<option value="dd MM yy"  <?php if($get_timeline_style[0]->rw_timeline_01=='dd MM yy'){ echo 'selected';}?>>  dd MM yy  </option>
							<option value="mm-dd-yy"  <?php if($get_timeline_style[0]->rw_timeline_01=='mm-dd-yy'){ echo 'selected';}?>>  mm-dd-yy  </option>
							<option value=""          <?php if($get_timeline_style[0]->rw_timeline_01==''){ echo 'selected';}?>>          mm.dd.yy  </option>
							<option value="dd.mm.yy"  <?php if($get_timeline_style[0]->rw_timeline_01=='dd.mm.yy'){ echo 'selected';}?>>  dd.mm.yy  </option>
							<option value="MM dd, yy" <?php if($get_timeline_style[0]->rw_timeline_01=='MM dd, yy'){ echo 'selected';}?>> MM dd, yy </option>
						</select>
					</td>
				...
				<tr>
					<td>
						<select class="Rich_Web_TI_Select_Menu" id="RW_TimeLine_1_7_PaginType" name="RW_TimeLine_1_7_PaginType">
							<option value="Pagination 1"   <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 1'){ echo 'selected';}?>>   Pagination 1   </option>
							<option value="Pagination 2"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 2'){ echo 'selected';}?>>  Pagination 2  </option>
							<option value="Pagination 3"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 3'){ echo 'selected';}?>>  Pagination 3  </option>
							<option value="Pagination 4"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 4'){ echo 'selected';}?>>  Pagination 4  </option>
							<option value="Pagination 5"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 5'){ echo 'selected';}?>>  Pagination 5  </option>
							<option value="Pagination 6"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 6'){ echo 'selected';}?>>  Pagination 6  </option>
							<option value="Pagination 7"  <?php if($get_timeline_style[0]->rw_timeline_03=='Pagination 7'){ echo 'selected';}?>>  Pagination 7  </option>
				</select>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginCol" name="RW_TimeLine_1_7_PaginCol" value="<?php echo $get_timeline_style[0]->rw_timeline_04;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginBackCol" name="RW_TimeLine_1_7_PaginBackCol" value="<?php echo $get_timeline_style_2[0]->rw_timeline_02;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginCurrCol" name="RW_TimeLine_1_7_PaginCurrCol" value="<?php echo $get_timeline_style_2[0]->rw_timeline_03;?>"/>
					</td>
				</tr>
				<tr>					
				...
				<tr>					
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginCurrBackCol" name="RW_TimeLine_1_7_PaginCurrBackCol" value="<?php echo $get_timeline_style_2[0]->rw_timeline_04;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginHoverCol" name="RW_TimeLine_1_7_PaginHoverCol" value="<?php echo $get_timeline_style_2[0]->rw_timeline_05;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_1_7_PaginHoverBackCol" name="RW_TimeLine_1_7_PaginHoverBackCol" value="<?php echo $get_timeline_style_2[0]->rw_timeline_06;?>"/>
					</td>
					<td>
						<div class="range-timeline">
							<input class="range-timeline__range RW_TimeLine_1_7_PaginFS" type="range" value="<?php echo $get_timeline_style_2[0]->rw_timeline_07;?>" id="RW_TimeLine_1_7_PaginFS" name="RW_TimeLine_1_7_PaginFS" min="10" max="25">
							<span class="range-timeline__value RW_TimeLine_1_7_PaginFS" id="$RW_TimeLine_1_7_PaginFS">0</span>
						</div>
					</td>					
					<tr>
					...
					<td>
						<select class="rich_web_timeline_color_font_family Rich_Web_TI_Select_Menu" id="RW_TimeLine_1_7_PaginFF" name="RW_TimeLine_1_7_PaginFF">
							<?php foreach($Rich_Web_SB_Fonts as $value) {
			...
			<table class="RW_Ti_Option_Table" id="RW_Ti_Option_TiTable_3">
				<td colspan="4">Pagination and Load more</td></tr>
				<tr>
					<td>Pagination Type</td>					
					<td>Color</td>
					<td>Background Color</td>
				...
				<tr>
					<td>
						<select class="Rich_Web_TI_Select_Menu" id="RW_TimeLine_8_PaginType" name="RW_TimeLine_8_PaginType">
							<option value="Pagination 1"   <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 1'){ echo 'selected';}?>>   Pagination 1   </option>
							<option value="Pagination 2"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 2'){ echo 'selected';}?>>  Pagination 2  </option>
							<option value="Pagination 3"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 3'){ echo 'selected';}?>>  Pagination 3  </option>
							<option value="Pagination 4"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 4'){ echo 'selected';}?>>  Pagination 4  </option>
							<option value="Pagination 5"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 5'){ echo 'selected';}?>>  Pagination 5  </option>
							<option value="Pagination 6"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 6'){ echo 'selected';}?>>  Pagination 6  </option>
							<option value="Pagination 6"  <?php if($get_timeline_style_4[0]->rw_timeline_title_bg_color=='Pagination 7'){ echo 'selected';}?>>  Pagination 7  </option>
				</select>
					</td>
					
					
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginCol" name="RW_TimeLine_8_PaginCol" value="<?php echo $get_timeline_style_3[0]->rw_timeline_year_block_bg_hover;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginBackCol" name="RW_TimeLine_8_PaginBackCol" value="<?php echo $get_timeline_style_3[0]->rw_timeline_year_size;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginCurrCol" name="RW_TimeLine_8_PaginCurrCol" value="<?php echo $get_timeline_style_5[0]->rw_timeline_md_color_hover;?>"/>
					</td>
				</tr>
				<tr>					
					<td>Current Background Color</td>
				...
				<tr>					
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginCurrBackCol" name="RW_TimeLine_8_PaginCurrBackCol" value="<?php echo $get_timeline_style_5[0]->rw_timeline_md_border_color;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginHovCol" name="RW_TimeLine_8_PaginHovCol" value="<?php echo $get_timeline_style_5[0]->rw_timeline_md_border_color_hover;?>"/>
					</td>
					<td>
						<input type="text" class="rich_web_timeline_color" id="RW_TimeLine_8_PaginHovBackCol" name="RW_TimeLine_8_PaginHovBackCol" value="<?php echo $get_timeline_style_5[0]->rw_timeline_round_border_col;?>"/>
					</td>
					<td>
						<select class="rich_web_timeline_color_font_family Rich_Web_TI_Select_Menu" id="RW_TimeLine_8_PaginFF" name="RW_TimeLine_8_PaginFF">
							<?php foreach($Rich_Web_SB_Fonts as $value) {
				...
				<td>
						<div class="range-timeline">
							<input class="range-timeline__range RW_TimeLine_8_PaginFS" type="range" value="<?php echo $get_timeline_style_3[0]->rw_timeline_box_shadow_hover;?>" id="RW_TimeLine_8_PaginFS" name="RW_TimeLine_8_PaginFS" min="10" max="25">
