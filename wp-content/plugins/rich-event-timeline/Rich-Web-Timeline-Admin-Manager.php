				...
				<tr class="Rich_Web_TI_SaveTable_TR">
					<td colspan="2" style="height: 25px;">
						<span class="RW_Timeline_ShowType_span">
							<input type="radio" name="RW_Timeline_ShowType" class="RW_Timeline_ShowType" value="All" checked> All
						</span>
						<span class="RW_Timeline_ShowType_span">
							<input type="radio" name="RW_Timeline_ShowType" class="RW_Timeline_ShowType" value="Pagination"> Pagination
						</span>
						<span class="RW_Timeline_ShowType_span">
							<input type="radio" name="RW_Timeline_ShowType" class="RW_Timeline_ShowType" value="Load More" > Load More
						</span>
						<input type="text" style="display: none;" class="RW_Timeline_ShowType_Val" name="RW_Timeline_ShowType_Val" value="" >
					</td>
				</tr>
				<tr class="Rich_Web_TI_SaveTable_TR">
				...
				<tr class="Rich_Web_TI_SaveTable_TR">
					<td>
						<div class="range-timeline">
							<input class="range-timeline__range rich_web_timeline_per_page" type="range" value="" id="rich_web_timeline_pp" name="rich_web_timeline_pp" min="0" max="30">
							<span class="range-timeline__value rich_web_timeline_pp_span" id="rich_web_timeline_pp_span">0</span>
						</div>
					</td>
					<td>
						<div class="pInputs pInputs1" style="display: none;">
							<input type="text" name="RW_Timeline_Prev_Text" id="RW_Timeline_Prev_Text" class="Rich_Web_TI_Select_Menu" value="Prev">
							<input type="text" name="RW_Timeline_Next_Text" id="RW_Timeline_Next_Text" class="Rich_Web_TI_Select_Menu" value="Next">
							
						</div>
						<div class="pInputs pInputs2" style="display: none;">
							<input type="text" name="RW_Timeline_LoadMore" id="RW_Timeline_LoadMore" class="Rich_Web_TI_Select_Menu" value="Load More ...">
