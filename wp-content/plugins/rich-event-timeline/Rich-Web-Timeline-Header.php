...
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Free_Version">
		<div class="Rich_Web_Header_Free_Version_Shd">
			<a href="http://rich-web.org/wp-event-timeline/" target="_blank" style="text-decoration: none; color: #fff; display: block;">
	...
	<div class="Rich_Web_Header_Contacts">
		<a href="http://rich-web.org/wordpress-timeline-vertical/" target="_blank">Demo</a>
		<a href="https://wordpress.org/plugins/rich-event-timeline/#faq" target="_blank">FAQ</a>
		<a href="https://wordpress.org/support/plugin/rich-event-timeline" target="_blank">Support</a>
