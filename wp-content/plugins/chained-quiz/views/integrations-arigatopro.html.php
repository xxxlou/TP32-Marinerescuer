<div class="wrap">
	<h1><?php _e("Integrate with Arigato PRO", 'chained');?></h1>
	
	<?php self :: tabs('arigatopro', $quizzes);?>	
	
	<p><?php _e('Here you can define which quizzes will automatically subscribe the respondents into selected mailing lists. Note that only quizzes which collect user email address are shown.', 'chained');?></p>
	...
	<h2><?php _e('Add New Subscription Rule', 'chained')?></h2>	  
	 ...
	 <form method="post">
	 	<div class="wrap">
				...
				<?php _e('subscribe them to mailing list','chained')?> 
	 			<select name="list_id">
