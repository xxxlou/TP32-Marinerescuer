...
EOT;
    ...
    protected function show_title()
    {
        ...
        echo  '<span style="vertical-align:top">' . esc_attr( $this->title ) . '</span>' ;
    }
    ...
    public function show()
    {
        ...
        if ( $this->show_page_title ) {
            ...
            if ( self::LIST_BASE_TABLE !== $this->table_name && (current_user_can( 'manage_options' ) && \WP_Data_Access_Admin::PAGE_MAIN === $this->page) ) {
                ...
                ?>"
								...
								title="<?php 
                echo  ( \WP_Data_Access_Admin::PAGE_MAIN === $this->page ? 'Data Explorer' : __( 'Favourites', 'wp-data-access' ) ) ;
                ?>"
						></a>
						<?php 
            }
            ...
            if ( WPDA_Dashboard::add_actions_to_page_title() && '' !== $help_url ) {
                ?>
						&nbsp;
						<span>
							<a href="<?php 
        ...
        ?>
				...
				<?php 
        if ( !is_admin() || 'wpda_wpdp_' === substr( $this->page, 0, 10 ) || WPDP::PAGE_TEMPLATES === $this->page || WPDA_Dashboard::add_actions_to_page_title() || substr( $this->page, 0, 13 ) === \WP_Data_Access_Admin::PAGE_EXPLORER ) {
