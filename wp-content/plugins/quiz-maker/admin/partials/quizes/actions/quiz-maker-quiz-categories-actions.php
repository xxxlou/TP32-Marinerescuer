            ...
            <div class="form-group row ays-question-button-box">
                ...
                <?php
                    if ( $nex_quiz_cat_id != "" && !is_null( $nex_quiz_cat_id ) ) {
                        ...
                        submit_button(__('Next Quiz Category', $this->plugin_name), 'button button-primary ays_default_btn ays-quiz-category-next-button-class ays-button ays-quiz-loader-banner', 'ays_question_next_button', false, $other_attributes);
                    }
                ?>
                </div>
            </div>
