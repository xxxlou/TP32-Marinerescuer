...
<div class="wrap">
    ...
    <div class="ays-quiz-community-wrap">
        ...
        <div class="ays-quiz-community-youtube-video">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/hhfdcPkadK8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        ...
        <div class="ays-quiz-asked-questions">
            ...
            <div class="ays-quiz-asked-question">
                ...
                <div class="ays-quiz-asked-question__body">                      
                    <p>
                        <?php echo
                        __( "Do you wonder how to create a Math Quiz with hard mathematical equations in WordPress? It is easier than you think. The Quiz Maker plugin itself does not have the functionality for adding math equations into questions. For adding", $this->plugin_name ) . 
                        ' <strong>'. __( "math equations" , $this->plugin_name ) .'</strong> ' . 
                        __("into the" , $this->plugin_name) . 
                        ' <strong>'. __( "Quiz Maker plugin" , $this->plugin_name ) .'</strong> ' .
                        __("you can make use of several math equation plugins such as" , $this->plugin_name) .
                        ' <a href="https://wordpress.org/plugins/mathjax-latex/" target="_blank">'. __( "MathJax - LaTex plugin" , $this->plugin_name ) .'</a>.<br> ' .
                        __("For adding the math equations just install and activate the mentioned plugin. It is one of the easiest math plugins. With the help of it, you can add as many equations as you need, even if they include several symbols. In this" , $this->plugin_name) . 
                        ' <a href="https://www.mathjax.org/#demo" target="_blank">'. __( "demo" , $this->plugin_name ) .'</a>, ' .
                        __("you can see a step-by-step tutorial on how to use MathJax. You have to be careful to use less-than signs, ampersands, and other HTML special characters within your math equations." , $this->plugin_name) . 
                        ' <br><br>' .
                        __("For example, to add a squared symbol, you need to write down the following sign ^2. (do not forget to insert $ character to mark the beginning and ending)." , $this->plugin_name); ?>
                    </p>
                </div>
            </div>
        </div>
