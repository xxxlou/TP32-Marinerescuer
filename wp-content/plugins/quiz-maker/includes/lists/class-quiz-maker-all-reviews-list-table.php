    ...
    public function extra_tablenav($which) {
        ...
        <div id="quiz-filter-div-<?php echo esc_attr( $which ); ?>" class="alignleft actions bulkactions">
            ...
            <select name="filterbyreview-<?php echo esc_attr( $which ); ?>" id="bulk-action-quiz-rate-selector-<?php echo esc_attr( $which ); ?>">
                <option value=""><?php echo __('Select Review',$this->plugin_name)?></option>
                <?php
            ...
            <input type="button" id="doaction-quiz-<?php echo esc_attr( $which ); ?>" class="quiz-review-filter-apply-<?php echo esc_attr( $which ); ?> button" value="<?php echo __( "Filter", $this->plugin_name ); ?>">
        </div>
