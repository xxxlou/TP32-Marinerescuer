...
class __TwigTemplate_924d02b0609ec8b5ad3825260e990970c9959b1275b0a74ca82e9e97879df275 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      ";
            // line 5
            if ((0 === twig_compare(($context["type"] ?? null), "primary"))) {
                // line 6
                echo "        ";
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["variable"]) {
          ...
          <td class=\"text-end font-monospace\">
            <span";
            // line 26
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["variable"], "status", [], "any", false, false, false, 26), "text-danger"))) {
                echo " class=\"text-danger\"";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["variable"], "status", [], "any", false, false, false, 26), "text-success"))) {
...
";
    ...
    {
        return new Source("", "server/replication/status_table.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_s9zvHjLrkRJyIgnPCM70hWp/templates/server/replication/status_table.twig");
    }
}
