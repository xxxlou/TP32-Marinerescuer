...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_s9zvHjLrkRJyIgnPCM70hWp/templates/preferences/header.twig");
    }
}
