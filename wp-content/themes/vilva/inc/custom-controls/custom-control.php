<?php
/**
 * Vilva Custom Control
 * 
 * @package Vilva
*/

if( ! function_exists( 'vilva_register_custom_controls' ) ) :
/**
 * Register Custom Controls
*/
function vilva_register_custom_controls( $wp_customize ){    
    ...
    $wp_customize->register_control_type( 'Vilva_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Vilva_Select_Control' );
    $wp_customize->register_control_type( 'Vilva_Slider_Control' );
    $wp_customize->register_control_type( 'Vilva_Toggle_Control' );
    $wp_customize->register_control_type( 'Vilva_Typography_Control' );
}
endif;
add_action( 'customize_register', 'vilva_register_custom_controls' );