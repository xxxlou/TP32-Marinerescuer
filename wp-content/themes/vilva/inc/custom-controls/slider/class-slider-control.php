<?php
/**
 * Vilva Customizer Slider Control.
 * 
 * @package Vilva
*/
...
if ( ! class_exists( 'Vilva_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Vilva_Slider_Control extends WP_Customize_Control {

		public $type = 'vilva-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'vilva-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'vilva-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
