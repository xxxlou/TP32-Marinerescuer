...
if( ! function_exists( 'vilva_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function vilva_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'vilva' ),
		__( 'Getting Started', 'vilva' ),
		'manage_options',
		'vilva-getting-started',
		'vilva_getting_started_page'
	);
}
endif;
add_action( 'admin_menu', 'vilva_getting_started_menu' );

if( ! function_exists( 'vilva_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function vilva_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_vilva-getting-started' != $hook ) return;

    wp_enqueue_style( 'vilva-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false, VILVA_THEME_VERSION );
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'vilva-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), VILVA_THEME_VERSION, true );
    wp_enqueue_script( 'vilva-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery' ), VILVA_THEME_VERSION, true );    
    wp_localize_script( 'vilva-recommended-plugin-install', 'vilva_start_page', array( 'activating' => __( 'Activating ', 'vilva' ) ) );
}
endif;
add_action( 'admin_enqueue_scripts', 'vilva_getting_started_admin_scripts' );

if( ! function_exists( 'vilva_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function vilva_call_plugin_api( $plugin ) {
...
if( ! function_exists( 'vilva_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function vilva_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'vilva_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function vilva_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'vilva' ), VILVA_THEME_NAME, VILVA_THEME_VERSION ); ?></h3>
				<h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'vilva' ), VILVA_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'vilva' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'vilva' ); ?>
                    </a>
                </li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'vilva' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'vilva' ); ?>
                    </a>
                </li>
			</ul>
